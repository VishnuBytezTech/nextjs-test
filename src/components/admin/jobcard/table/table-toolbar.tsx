...
import FilterDrawerView from '@/app/shared/explore-listing/listing-filters/drawer-view';
...
export default function JobCardTableToolbar<TData extends Record<string, any>>({
  table,
