...
} from '@/components/table/main-table-types';
...
export function JobCardExpandedComponent<TData extends Record<string, any>>(
  row: Row<TData>
) {
  return (
    <div className="grid grid-cols-1 divide-y border-y border-muted/70 bg-gray-0 px-3.5 dark:bg-gray-50">
        <p>this tag from the jobcard expandaed component</p>
