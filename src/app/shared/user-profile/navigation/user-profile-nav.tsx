...
export default function UserProfileNav() {
  ...
  return (
    <div
      className={cn(
        'sticky z-20 bg-white -mx-4 -mt-4 border-b border-muted  px-4 py-0 font-medium text-gray-500 sm:-mt-2 md:-mx-5 md:px-5 lg:-mx-8 lg:mt-0 lg:px-8 xl:-mx-6 xl:px-6 2xl:top-20 3xl:-mx-[33px] 3xl:px-[33px] 4xl:-mx-10 4xl:px-10 dark:bg-gray-50',
