...
import { GetColumns } from '@/app/shared/manager-user/users/list/columns';
...
import { fetchJobTypesThunk } from '@/redux/features/job-type-slice';
import { fetchUsersThunk } from '@/redux/features/user-invitation-slice';
...
export default function UsersListTable() {
  ...
  const users = useSelector(
    (state:RootState) => state.userinvitationreducer.users
  )

  console.log("Users list  data ::::::", users)

  const next = useSelector((state:RootState) => state.userinvitationreducer.next)
  const prev = useSelector((state:RootState) => state.userinvitationreducer.previous)
  ...
  useEffect(()=>{
    console.log("user type fetch api is working form ")
    dispatch(fetchUsersThunk({authToken:authToken as string, limit, offset}))
        ...
        users && users.length ?  (
          ...
          >
            <ControlledTable
              ...
              //   total: totalItems,
              //   current: currentPage,
              //   nextPageUrl: jobTypes.next,
              //   prevPageUrl: jobTypes.previous,
