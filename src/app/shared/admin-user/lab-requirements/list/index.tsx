...
import { GetColumns } from '@/app/shared/admin-user/lab-requirements/list/columns';
...
import { fetchLabReqThunk } from '@/redux/features/lab-requirement-slice';
...
export default function LabRequirementsTable() {
  ...
  const labRequirementData = useSelector((state:RootState) => state.labrequirementreducer.labRequirements)

  console.log("lab requirement data :::", labRequirementData)
  console.log("lab requirement data :::", labRequirementData)

  const next = useSelector((state:RootState) => state.labrequirementreducer.next)
  const prev = useSelector((state:RootState) => state.labrequirementreducer.previous)
  ...
  useEffect(()=>{
    dispatch(fetchLabReqThunk({authToken:authToken as string, limit, offset}))
  ...
  const {
    ...
    setSelectedRowKeys,
    selectedRowKeys,
  } = useTable(labRequirementData, pageSize, filterState);


  const columns = useMemo(
    () =>
      GetColumns({
        data: labRequirementData,
        sortConfig,
  ...
  return (
    <>
      {
        labRequirementData && labRequirementData.length ?  (
