...
import { GetColumns } from '@/app/shared/admin-user/prep-lab-requirement/list/columns';
...
import { fetchClientsThunk } from '@/redux/features/client-slice';
import { AppDispatch, RootState } from '@/redux/store';
import { useStartTyping } from 'react-use';
import { fetchPrepLabRequirementsThunk } from '@/redux/features/prep-lab-requirement-slice';
...
export default function PrepLabRequirementsListTable() {
  ...
  const prepLabReqData = useSelector(
    (state:RootState) => state.preplabrequirementreducer.prepLabRequirements
  )

  console.log("prep lab data ::", prepLabReqData)

  const next = useSelector((state:RootState) => state.clientreducer.next)
  const prev = useSelector((state:RootState) => state.clientreducer.previous)
  ...
  useEffect(()=>{
    dispatch(fetchPrepLabRequirementsThunk({authToken:authToken as string, limit, offset}))
  ...
  const {
    ...
    setSelectedRowKeys,
    selectedRowKeys,
  } = useTable(prepLabReqData, pageSize, filterState);
  ...
  return (
    <>
      {
        prepLabReqData && prepLabReqData.length ?  (
          ...
          >
            <ControlledTable
              ...
              //   total: totalItems,
              //   current: currentPage,
              //   nextPageUrl: "clients.next",
              //   prevPageUrl: "clients.previous",
