...
import { GetColumns } from '@/app/shared/admin-user/client/list/columns';
...
export default function ClientListTable() {
  ...
  useEffect(()=>{
    dispatch(fetchClientsThunk({authToken: authToken as string, limit, offset}))
  }, [authToken as string, limit, offset, dispatch])
  ...
  const {
    ...
    setSelectedRowKeys,
    selectedRowKeys,
  } = useTable(clientData, pageSize, filterState);
