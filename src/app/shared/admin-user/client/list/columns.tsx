...
import ClientDetails from '../client-view';
///////////////////////////////////////////
...
export const GetColumns = ({
  ...
  return [
...

    {
      ...
      key: 'email',
      width: 180,
      render: (emailObj: { email: string }) => {
        // console.log('emailObj:', emailObj); // Log the emailObj to check its structure
...

    {
      ...
      key: 'phone',
      width: 120,
      render: (phone: { phone: string } | string) => {
        // console.log('phone:', phone); // Log the phone to check its structure
...

    {
      ...
      render: (country: CountryData | string) => {
        console.log("country :::::", country)
        if (typeof country === 'object' && 'name' in country) {
          return (
