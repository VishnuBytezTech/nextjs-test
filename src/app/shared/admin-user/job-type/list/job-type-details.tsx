...
export default function JobTypeDetails({
  data,
  onDelete,
  onEdit,
}: {
  ...
  return (
    <div className="block">
      ...
      <div className="p-5 md:px-7 md:pb-7 md:pt-6">
        ...
        >
{/*            
           <span className='text-lg font-medium md:text-xl'>{data?.name}'s </span>
           <span className='text-lg font-light md:text-xl'>details</span> */}
        </Title>

          {/* <ul className="mt-7 space-y-4 text-xs sm:text-sm">
            <li className="flex items-center">
              <PiCalendarCheckLight className="me-2 hidden w-5 shrink-0 text-xl" />
              <span className="label">Appointment Start:</span>{' '}
            ...
            <li className="flex items-center">
              <PiCalendarCheckLight className="me-2 hidden w-5 shrink-0 text-xl" />
              <span className="label">Appointment End:</span>{' '}
              <span className="ps-2 font-medium text-gray-1000">
                {dayjs(data.date)
