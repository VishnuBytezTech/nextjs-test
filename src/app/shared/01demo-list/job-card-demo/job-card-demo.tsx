...
export default function JobCardDemo({
  ...
  return (
    <div className={cn('rounded-lg border border-muted shadow-md p-6', className)}>
      ...
      <div className="mt-4 flex items-center gap-2">
        <div className="flex items-center">
            <p>job card description job card description job card description job card description job card description</p>
        </div>
      </div>
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        <span>Total {users.length} users commented</span>
      </div>
      <ModalButton
        customSize="700px"
        variant="outline"
