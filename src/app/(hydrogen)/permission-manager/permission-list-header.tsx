...
import CreatePermission from '@/app/shared/permission-manager/permission-form/create-premission';
...
export default function PermissionListPageHeader({ className }: HeaderProps) {
