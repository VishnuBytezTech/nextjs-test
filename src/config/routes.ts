export const routes = {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////
  // RC requirments routes
  ///////////////////////////////////////////////////////////////////////////////
  admin:{
    adminDashboard: '/admin-dashboard',

    // Jobcard urls
    jobCardPanel:'/admin-dashboard/job-card-list',
    jobcardCreate: '/admin-dashboard/job-card-list/create',
    jobCardDetails: '/admin-dashboard/job-card-list/jobcard-details',

    // client management urls
    clients : '/admin-dashboard/clients-manage',

    // Commodity management urls
    commodity : '/admin-dashboard/commodity',

    // job-type management urls
    jobtype : '/admin-dashboard/job-type',

    // Lab requirement management urls
    labrequirement : '/admin-dashboard/lab-requirements',

    // Prep lab requirement management urls
    prepLabRequirement : '/admin-dashboard/prep-lab-requirements',

    //
    usersManagement: '/admin-dashboard/users'
