...
export const siteConfig = {
  ...
  // Need to add site description in here
  logo: logoImg,
  icon: logoIconImg,
  mode: MODE.LIGHT,
...
export const metaObject = (
  ...
  return {
    title: title ? `${title} - RC Inspection` : siteConfig.title,
    description,
    openGraph: openGraph ?? {
      title: title ? `${title} - RC Inspection` : title,
      description,
      url: 'https://isomorphic-furyroad.vercel.app',
      siteName: 'RC Inspection', // https://developers.google.com/search/docs/appearance/site-names
      images: {
