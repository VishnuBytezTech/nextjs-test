export const messages = {
  ...
  // RC inspections messages
  routeNameIsRequired: 'The route name must be required',
  pageNameIsRequired: 'The page name must be required',
  actionsCannotNumber: 'Action field cannot contain numbers',

  //  Create jobcard messages
  clientNameIsRequired: 'client name is required',
  commodityIsRequired: 'Commodity is requirerd',
  countryIsRequired: "Country is required ",
  addressIsRequired: "Address is required ",
  cityIsRequired: "City is required ",

  // create commodity 
  commodityNameIsRequired: "Commodity name is required",  

  // create job type
  jobTypeNameIsRequired: "Job type name is required",

  // create job type
  labRequirementNameIsRequired: "Lab requirement name is required",

  // create Prep lab requirement 
  prepLabRequirementNameIsRequired: "Prep lab requirement name is required",

  // create user by user invite
  ...
  clientRefIsRequired: 'Client ref is requirerd',
  typeofjobIsRequired: 'Type of job is requirerd',
  statusIsRequired: 'status is requirerd',
  startDateIsRequired: 'Start date is requirerd',
  endDateIsRequired: 'End date is requirerd',
